      <?php
         require dirname(__FILE__) . './cabecera/header.php';
      ?>
   </head>
   ...
   <body>
               ...
               <div class="formLogin">
                  <div class="row">
                     <div class="col-md-12 mx-auto text-center">
                        ...
                        <img src="./librerias/img/register.png" alt="Login" class="mx-auto imgLogin" />
                     </div>
                  </div>
      ...
      <?php
         require dirname(__FILE__) . './cabecera/footer.php';
      ?>

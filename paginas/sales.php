      ...
      <div class="container">
         ...
         <div class="row d-flex justify-content-between align-items-center">
            ...
            <div class="col-md-6 text-end">            
               <button id="btnNuevo" type="button" class="btn btn-primary btn-sm btnLogin" onclick="openModalRanking();">
         ...
         <div class="modal-dialog">
            <div class="modal-content">
               ...
               <div class="modal-footer d-flex justify-content-between align-items-center">
                  ...
                  <button type="button" class="btn btn-primary btn-sm btnLogin" onclick="totalCalculate();">
                     Calcular
                  </button>
                  <button type="button" class="btn btn-success btn-sm btnLogin" onclick="saveVenta();">
                     Guardar
                  </button>
               </div>
            </div>
               ...
               "columns": [
                  ...
                  {"data": null,
                     render: function (data, type, row) {
                        return `<center><button type='button' class='btn btn-danger bt-sm btnProcess' onclick="deleteVenta('${row.idVenta}', '${row.nameCliente}', '${row.fecha}');">Eliminar</button></center>`
                     }
                  }
               ],
               "language": idioma,

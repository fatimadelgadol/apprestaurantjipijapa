         ...
         <div class="modal-dialog">
            <div class="modal-content">
               ...
               <div class="modal-footer">
                  ...
                  <button type="button" class="btn btn-success btn-sm btnLogin" onclick="saveUser();">
                     Guardar
                  </button>
               </div>
            </div>
               ...
               "columns": [
                  ...
                  {"data": null,
                     render: function (data, type, row) {
                        return `<center><button type='button' class='btn btn-danger bt-sm btnProcess' onclick="deleteUser('${row.cedula}', '${row.apellidos}', '${row.nombres}');">Eliminar</button></center>`
                     }
                  }
               ],
               "language": idioma,

         ...
         <div class="modal-dialog">
            <div class="modal-content">
               ...
               <div class="modal-footer">
                  ...
                  <button type="button" class="btn btn-success btn-sm btnLogin" onclick="savePlato();">
                     Guardar
                  </button>
               </div>
            </div>
         ...
         <div class="modal-dialog">
            <div class="modal-content">
               ...
               <div class="modal-footer">
                  ...
                  <button type="button" class="btn btn-success btn-sm btnLogin" onclick="updatePlato();">
                     Actualizar
                  </button>
               </div>
            </div>
               ...
               "columns": [
                  ...
                  {"data": null,
                     render: function (data, type, row) {
                        return `<center><button type='button' class='btn btn-primary bt-sm btnProcess' onclick="modalOpenEdit('${row.idPlato}', '${row.nombrePlato}', '${row.precioPlato}', '${row.tipoPlato}');">Editar</button>
                        <button type='button' class='btn btn-danger bt-sm btnProcess' onclick="deletePlato('${row.idPlato}', '${row.nombrePlato}');">Eliminar</button></center>`
                     }
                  }
               ],
               "language": idioma,

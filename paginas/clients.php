      <?php
         include dirname(__FILE__) . './cabecera/header.php';
      ?>
   ...
   <body>
      <div class="container">
         <?php
            include dirname(__FILE__) . './cabecera/Navbar.php';
         ?>
         ...
         <div class="row">
            <div class="col-md-5">            
               <button id="btnNuevo" type="button" class="btn btn-danger btn-sm btnLogin" onclick="modalOpen();">
      ...
      <?php
         include dirname(__FILE__) . './cabecera/footer.php';
      ?>
         ...
         <div class="modal-dialog">
            <div class="modal-content">
               ...
               <div class="modal-footer">
                  <button type="button" class="btn btn-secondary btn-sm btnLogin" data-bs-dismiss="modal">
                     Cerrar
                  </button>
                  <button type="button" class="btn btn-success btn-sm btnLogin" onclick="saveClient();">
                     Guardar
                  </button>
               </div>
            </div>
         ...
         <div class="modal-dialog">
            <div class="modal-content">
               ...
               <div class="modal-footer">
                  ...
                  <button type="button" class="btn btn-success btn-sm btnLogin" onclick="updateClient();">
                     Actualizar
                  </button>
               </div>
            </div>
               ...
               "columns": [
                  ...
                  {"data": null,
                     render: function (data, type, row) {
                        return `<center><button type='button' class='btn btn-primary bt-sm btnProcess' onclick="modalOpenEdit('${row.cedula}', '${row.apellidos}', '${row.nombres}', '${row.telefono}', '${row.direccion}', '${row.genero}', '${row.fechNacimiento}');">Editar</button>
                        <button type='button' class='btn btn-danger bt-sm btnProcess' onclick="deleteClient('${row.cedula}', '${row.apellidos}', '${row.nombres}');">Eliminar</button></center>`
                     }
                  }
               ],
               "language": idioma,
